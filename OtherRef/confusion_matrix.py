...
def resnet34_load_weights(model, weight_path, strict=False):
...
model.load_state_dict(torch.load("yugioh_model/mbnet3s_digital_to_irl_95.pth"))

# model = ResNet34_Gradual_Unfreezing(num_classes=num_classes)
# model = resnet34_load_weights(model, 'yugioh_model/resnet34_v3_final.pth')
...
test_dataset = datasets.ImageFolder("yugioh_irl", transform=transform)
# test_dataset = datasets.ImageFolder("yugioh_card", transform=transform)
